...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin{
  ...
  void CheckVersion()async{
    final newversion=NewVersion(
        androidId: "allphanes.com.allphanes"
    );
  ...
  Future<void> fetchusercanvas()async{
    ...
    http.Response response=await http.get(Uri.parse("https://api.allphanes.com/api/posts/multiplefilters?private=1&token=$userid&skip=12&&lang="));
 ...
 void dispose(){
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: mycanvasdata==null?Container(
          ...
          // ),
           ...
           Stack(
             children: [
               ...
               ListView.builder(
                 itemCount: mycanvasdata!=null?mycanvasdata["responseData"].length:0,
                 itemBuilder: (BuildContext context,index){
                       ...
                       children: [
                                       ...
                                       child: GestureDetector(
                                         ...
                                         child: Container(
                                           ...
                                           decoration: BoxDecoration(
                                             shape: BoxShape.circle,
                                             //color: Colors.green,
                                             image: mycanvasdata["responseData"][index]["user_info"][0]["profilePhoto"]!=""?DecorationImage(
                                               image:
                                               CachedNetworkImageProvider("${mycanvasdata["responseData"][index]["user_info"][0]["profilePhoto"]}",),fit: BoxFit.fill
                                             ):
                                             ...
                                             fit: BoxFit.scaleDown,
                                               child: SizedBox(child: GestureDetector(
                                                 onTap: ()async{
                                                   ...
                                                   child: Text("${mycanvasdata["responseData"][index]["user_info"][0]["showName"]}",style: TextStyle(fontSize: 2.5.w,fontWeight: FontWeight.bold),textAlign: TextAlign.justify))
                                               )
                                           ),
                                     ...
                                     children: [
                                       IconButton(
                                         onPressed: ()async{
                                           ...
                                           tap.TapOnFavorite(mycanvasdata["responseData"][index]["referenceUserId"],mycanvasdata["responseData"][index]["_id"]).then((value) =>fetchusercanvas() );

                                         },
                                         icon: Icon(Icons.bookmark,color:mycanvasdata["responseData"][index]["isFav"].length>0 && mycanvasdata["responseData"][index]["isFav"][0]["mark"]==false? Colors.grey:Colors.red,size: 3.5.h,),
                                       ),
                                       PopupMenuButton(
                                           itemBuilder: (_) => <PopupMenuItem<String>>[
                                             // PopupMenuItem<String>(
                                             //     child: Text('Block'), value: 'block'),
                                            mycanvasdata["responseData"][index]["referenceUserId"]!=allphanesuserdata!.getString("userid")?
                                             PopupMenuItem<String>(
                         ...
                         Padding(
                           ...
                           child: Row(
                             mainAxisAlignment: MainAxisAlignment.start,
                             children: [
                               Text(mycanvasdata["responseData"][index]["postTitle"]!="Quick Post"?"${mycanvasdata["responseData"][index]["postTitle"]}":"",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 16),),
                             ],
                           ),
                         ),
                         mycanvasdata["responseData"][index]["postInfo"].length>0?Padding(
                           padding: const EdgeInsets.all(8.0),
                           child: Column(
                             children: [
                               Image(
                                   image:CachedNetworkImageProvider("${mycanvasdata["responseData"][index]["postInfo"][0]["postImagePath"]}")
                                 //image: NetworkImage("https://res.cloudinary.com/dsg7oitoj/image/upload/v1657552770/hhhx9auezdx2e14skekg.jpg"),
                               ),
                               Row(
                                 mainAxisAlignment: MainAxisAlignment.start,
                                 children: [
                                   Text(mycanvasdata["responseData"][index]["keywords2"]!=null?"${mycanvasdata["responseData"][index]["keywords2"]}":"",style: TextStyle(color: Colors.blue,fontSize: 14))
                                 ],
                               )
                             ],
                           ),
                             ...
                             Padding(
                               ...
                               child: Column(
                                 children: [
                                   Text("${mycanvasdata["responseData"][index]["postDescription"]}",style: TextStyle(color: Colors.black,fontSize: 14),textAlign: TextAlign.justify,),
                                   Row(
                                     mainAxisAlignment: MainAxisAlignment.start,
                                     children: [
                                       Text(mycanvasdata["responseData"][index]["keywords2"]!=null?"${mycanvasdata["responseData"][index]["keywords2"]}":"",style: TextStyle(color: Colors.blue,fontSize: 14))
                         ...
                         mycanvasdata["responseData"][index]["postType"]=="Normal"?Container():
                             Padding(
                               ...
                               child: Container(
                                 ...
                                 child: Column(
                                   ...
                                   children: [
                                               ...
                                               children: [
                                                 Padding(
                                                   ...
                                                   child: GestureDetector(
                                                     onTap: ()async{
                                                       allphanesuserdata=await SharedPreferences.getInstance();
                                                       Navigator.push(context, MaterialPageRoute(builder: (context)=>MySpace(allphanesuserdata!.getString("userid"), mycanvasdata["responseData"][index]["shareUserId"])));
                                                     },
                                                     child: Container(
                                                       height: 6.h,
                                                       width: 6.h,
                                                       decoration: BoxDecoration(
                                                           shape: BoxShape.circle,
                                                           //color: Colors.green,
                                                           image: mycanvasdata["responseData"][index]["shareProfile"]!=""?DecorationImage(
                                                               image:
                                                               CachedNetworkImageProvider("${mycanvasdata["responseData"][index]["shareProfile"]}",),fit: BoxFit.fill
                                                           ):
                                                           DecorationImage(image: AssetImage("images/default_profileimage.png"),fit: BoxFit.contain)
                                                       ),
                                                     ),
                                                     ...
                                                     children: [
                                                       FittedBox(
                                                           ...
                                                           child: SizedBox(child: GestureDetector(
                                                               ...
                                                               child: Text("${mycanvasdata["responseData"][index]["shareFullName"]}",style: TextStyle(fontSize: 2.5.w,fontWeight: FontWeight.bold),textAlign: TextAlign.justify))
                                                           )
                                                       ),
                                                       //Text("${calculatetime(mycanvasdata["responseData"][index]["createdAt"])}",style: TextStyle(color: Colors.grey,fontSize: 12),),
                                                     ],
                                     ...
                                     mycanvasdata["responseData"][index]["shareGalleryInfo"]==""?Container():
                                         Padding(
                                           padding: const EdgeInsets.all(8.0),
                                           child: Image(image: CachedNetworkImageProvider('${mycanvasdata["responseData"][index]["shareGalleryInfo"]}'),fit: BoxFit.contain,),
                                         ),

                                     mycanvasdata["responseData"][index]["shareDescription"]==""?Container():
                                         Padding(
                                           padding: const EdgeInsets.all(8.0),
                                           child: Column(
                                             children: [
                                               Row(
                                                 mainAxisAlignment: MainAxisAlignment.center,
                                                 children: [
                                                   Text("${mycanvasdata["responseData"][index]["shareDescription"]}",style: TextStyle(color: Colors.black,fontSize: 12),textAlign: TextAlign.justify,),
                                                 ],
                                               ),
                                               Row(
                                                 mainAxisAlignment: MainAxisAlignment.start,
                         ...
                         Padding(
                           ...
                           child: Row(
                             ...
                             children: [
                               IconButton(
                                 icon: Icon(Icons.favorite,color:mycanvasdata["responseData"][index]["isLiked"].length<1? Colors.grey:Colors.red,size: 3.h,),
                                 onPressed: ()async{
                                   IconButtonsTap tap=await new IconButtonsTap(allphanesuserdata!.getString("userid"));
                                   tap.TapOnLike(mycanvasdata["responseData"][index]["referenceUserId"],mycanvasdata["responseData"][index]["_id"]).then((value) =>fetchusercanvas() );
                                   },
                               ),
                               ...
                               IconButton(
                                 ...
                                 onPressed: (){
                                   if(allphanesuserdata!.getString("userid")==mycanvasdata["responseData"][index]["referenceUserId"]){
                                     ...
                                     Navigator.push(context, MaterialPageRoute(builder: (context)=>SharePost(mycanvasdata["responseData"][index])));
                                   }
                                   },
                               ),
                         ...
                         Padding(
                           ...
                           child: Row(
                             ...
                             crossAxisAlignment: CrossAxisAlignment.center,
                             children: [
                               Text("${mycanvasdata["responseData"][index]["totalLikes"]} Likes  ${mycanvasdata["responseData"][index]["totalComment"]} Comments",style: TextStyle(color: Colors.grey,fontSize: 12),),
                             ],
                           ),
                         ),
                           ...
                           child: Row(
                             ...
                             children: [
                               ...
                               ElevatedButton(
                                 ...
                                 onPressed: ()async {
                                   allphanesuserdata=await SharedPreferences.getInstance();
                                   CommentPost commentpost=await new CommentPost(allphanesuserdata!.getString("userid"));
                                   commentpost.postComment(mycanvasdata["responseData"][index]["_id"],textcontroller![index].text).then((value)
                                   {
                                     fetchusercanvas();
                                     setState((){
                         ...
                         mycanvasdata["responseData"][index]["user_comment"].length>0?
                         Padding(
                           padding: const EdgeInsets.all(8.0),
                               ...
                               ExpansionPanel(
                                   ...
                                   body: Container(
                                     ...
                                     child: ListView.builder(
                                       itemCount: mycanvasdata["responseData"][index]["user_comment"].length,
                                       itemBuilder: (BuildContext context,index1){
                                         return Padding(
                                           ...
                                           child: Row(
                                             ...
                                             crossAxisAlignment: CrossAxisAlignment.center,
                                             children: [
                                               Text("${mycanvasdata["responseData"][index]["user_comment"][index1]["messageText"]}",style: TextStyle(color: Colors.black),)
                                             ],
                                           )
                                         );
                                       },
